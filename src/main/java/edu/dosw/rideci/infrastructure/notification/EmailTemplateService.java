...
public class EmailTemplateService {
    ...
    public String buildPasswordRecoveryEmail(String userName, String appName,
                                             String recoveryLink, int expirationMinutes) {
        return """
            <html>
              <body>
                <p>Hola %s,</p>
                ...
                <p>
                  Si fuiste tú quien solicitó el cambio, haz clic en el siguiente enlace
                  para crear una nueva contraseña:
                </p>
                <p style="text-align:center;">
                  <a href="%s"
                     style="background-color:#395BCA;color:#ffffff;padding:10px 20px;
                            text-decoration:none;border-radius:4px;text-decoration:none;">
                    Restablecer contraseña
                  </a>
                </p>
                <p>
                  Por seguridad, este enlace expirará en %d minutos. Si no solicitaste
            ...
            """.formatted(userName, appName, recoveryLink, expirationMinutes, appName);
    }
