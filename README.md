...
🔌 Adapters (Infrastructure): Implementations of the ports that connect the domain with specific technologies like databases, RabbitMQ, SMTP e integración con otros módulos.
...
Administration Module (ATENEA_ADMINISTRATION_BACKEND)
...
Email Provider / SMTP (Office 365 or others)
